...
:title: Upbound Universal Crossplane with SUSE Rancher
:productname: SUSE Rancher 2.6
:author1: Yury Tsarev, Principal Solutions Architect, Upbound
:author2: Samip Parikh, Alliances Solutions Architect, SUSE
